...
-- reg_files
CREATE TABLE IF NOT EXISTS `reg_files` (
        `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
...
-- reg_persona_files
CREATE TABLE IF NOT EXISTS `reg_persona_files` (
        `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
...
-- reg_guardians
CREATE TABLE IF NOT EXISTS `reg_guardians` (
        `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
        `student_id` INT UNSIGNED NOT NULL,
...
-- reg_academic_history
CREATE TABLE IF NOT EXISTS `reg_academic_history` (
        `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
        `student_id` INT UNSIGNED NOT NULL,
...
-- reg_student_statuses
CREATE TABLE IF NOT EXISTS `reg_student_statuses` (
        `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
        `student_id` INT UNSIGNED NOT NULL,
...
-- reg_doc_requests
CREATE TABLE IF NOT EXISTS `reg_doc_requests` (
        `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
...
-- reg_doc_request_items
CREATE TABLE IF NOT EXISTS `reg_doc_request_items` (
        `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
